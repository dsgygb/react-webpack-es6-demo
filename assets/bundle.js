...
/***/ function(module, exports, __webpack_require__) {
	...
	var showdown = __webpack_require__(153),
	...
	var CommentForm = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement('input', { type: 'text', placeholder: '姓名', ref: 'author' }),
	            React.createElement('input', { type: 'text', placeholder: '留言内容', ref: 'text' }),
	            React.createElement('input', { type: 'submit', value: '发送' })
	        );
	    }
	});
	...
	var CommentList = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var commentNodes = this.props.data.map(function (comment, i) {
	            return React.createElement(
	                Comment,
	                { key: "comment_" + i, author: comment.author },
	                comment.text
	            );
	        });
	...
	React.render(React.createElement(CommentBox, { pollInterval: '5000', postUrl: config.baseApiUrl + "/comment", url: config.baseApiUrl + "/comments" }), document.getElementById('content'));
